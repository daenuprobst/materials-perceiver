...
def get_version(dist: str = "materials-perceiver") -> str:
...
def get_debug_info() -> Environment:
    ...
    packages = ["materials-perceiver"]
    variables = ["PYTHONPATH", *[var for var in os.environ if var.startswith("MATERIALS_PERCEIVER")]]
    return Environment(
